...
export const Wayfarer = simpleGit(`./wayfarer`)
...
// // * the server starts a time interval, then starts to check if dirty and commit
...
// C. SERVER_MEMORY
// // Each /wayfarer/ route corresponds to a file in the wayfarer/src/ submodule files
